...
def sentiment(query, start, end):
	auth = tweepy.auth.OAuthHandler('j3KuVlGlDsSxCozoVfEaLgRyR', 'tpDWEUicXb6BxiFdTkoX6vZo3vJLVYa1PoFWF3fVw6XHmDRn74')
	auth.set_access_token('922587032051785728-k0v1FRY1jx9FIh0yO1wrNQxB3ELErlL', '0uxeQE0bNtvWSv8gB2DSCaTajQNDMCMUVuOCoSWOt0ArI')
	api = tweepy.API(auth)
